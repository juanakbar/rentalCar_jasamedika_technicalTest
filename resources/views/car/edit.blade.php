                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <p>Car Name</p>
                                <input type="text" class="form-control" required name="car_name"
                                    value="{{ $car->car_name }}">
                            </div>
                            <div class="form-group">
                                <p>Year</p>
                            ...
                            <div class="form-group">
                                <p>License Plat</p>
                                <input type="text" class="form-control" required name="license_plat"
                                    value="{{ $car->license_plat }}">
                            </div>
                        </div>
                                ...
                                <select name="brand_id" class="form-control">
                                    ...
                                    @foreach ($brands as $brand)
                                        <option value="{{ $brand->brand_id }}"
                                            {{ $car->brand_id == $brand->brand_id ? 'selected' : '' }}>
